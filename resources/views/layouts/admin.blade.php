    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#images-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-image"></i><span>Images</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#audios-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-soundwave"></i><span>Audios</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="audios-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('audios.index')}}">
              <i class="bi bi-circle"></i><span>All Audios</span>
            </a>
          </li>
          <li>
